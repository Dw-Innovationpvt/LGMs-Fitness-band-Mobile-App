...
// // Add WaterGoalCelebration component here
// const WaterGoalCelebration = ({ isGoalAchieved, onCelebrationComplete }) => {
//   const [showCelebration, setShowCelebration] = useState(false);

//   useEffect(() => {
//     if (isGoalAchieved && !showCelebration) {
...
//     }
//   }, [isGoalAchieved, showCelebration, onCelebrationComplete]);
...
//     // Track if water goal celebration has been shown
//   const [waterCelebrationShown, setWaterCelebrationShown] = useState(false);

//   // Determine if water goal is achieved
//   const isWaterGoalAchieved = todayTotal >= target && target > 0 && !waterCelebrationShown;

//   useEffect(() => {
//     if (isWaterGoalAchieved) {
//       setWaterCelebrationShown(true);
//     }
//     // Reset celebration if user falls below target (e.g., on a new day)
//     if (todayTotal < target && waterCelebrationShown) {
//       setWaterCelebrationShown(false);
//     }
//   }, [todayTotal, target, isWaterGoalAchieved, waterCelebrationShown]);



//   return (
//     <>
//           {/* Water goal celebration confetti */}
//       <WaterGoalCelebration
//         isGoalAchieved={isWaterGoalAchieved}
//         onCelebrationComplete={() => setWaterCelebrationShown(true)}
//       />
//       <SafeAreaView style={styles.safeArea}>
//         <LinearGradient
//           colors={['#4B6CB7', '#182848']}
