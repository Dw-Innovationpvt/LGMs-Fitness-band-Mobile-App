...
const ProfileScreen = ({ navigation }) => {
    ...
    // Add skating preferences state
    const [skatingPreferences, setSkatingPreferences] = useState({
        skateType: 'inline',
        wheelDiameter: '90 mm'
    });
    ...
    // Function to handle skating preferences update
    const handleSkatingPreferencesUpdate = (updatedPrefs) => {
        setSkatingPreferences(updatedPrefs);
        // You might want to save these to your backend as well
        AsyncStorage.setItem('skatingPreferences', JSON.stringify(updatedPrefs));
    };
    ...
    // New tab for skating preferences
    const renderSkatingTab = () => (
        <View style={styles.tabContent}>
            ...
            <TouchableOpacity
                style={styles.optionCard}
                onPress={() => navigation.navigate('SkatePreference', {
                    currentPreferences: skatingPreferences,
                    onUpdatePreferences: handleSkatingPreferencesUpdate
                })}
                accessible={true}
...
const styles = StyleSheet.create({
    ...
    /* Commented out unused styles as per request
...
//             streak: 7
//         },
//         // Commented out achievements as per request
//         /* achievements: [
...
//         ], */
//         // Commented out progress as per request
//         /* progress: [
//             { day: 'Mon', minutes: 30 },
//             { day: 'Tue', minutes: 45 },
//             { day: 'Wed', minutes: 0 },
...
//             { day: 'Sun', minutes: 15 }
//         ], */
//         // Commented out goals as per request
//         /* goals: [
...
//         // const res = logout();
//         // if (res.error) {
//         //     console.warn('Error logging out:', res.error);
...
//                 <Feather name="chevron-right" size={20} color="#999" />
//             </TouchableOpacity>
//             {/* Removed Notifications from navigation options as per request */}
//             {['AccountSettings', 'Privacy'].map((screen) => (
//                 <TouchableOpacity
//                     key={screen}
//                     style={styles.optionCard}
...
//                 </TouchableOpacity>
//                 <Text style={styles.headerTitle}>Profile</Text>
//                 {/* Changed settings icon to logout icon in red as per request */}
//                 <TouchableOpacity accessible={true} accessibilityLabel="Log out" onPress={handleLogout}>
//                     <Feather name="log-out" size={24} color="#F44336" />
//                 </TouchableOpacity>
//             </LinearGradient>
...
//                     </View>
//                 </View>
//                 {/* Simplified tab bar to only show profile tab as per request */}
//                 <View style={styles.tabBar}>
//                     <TouchableOpacity
